...
class Ui_WinAdd(object):
    def setupUi(self, WinAdd):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Interface/Images/bancerahn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox.addItem(icon, "")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Interface/Images/banderausa.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Interface/Images/cancel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        self.btnAdd.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Interface/Images/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
