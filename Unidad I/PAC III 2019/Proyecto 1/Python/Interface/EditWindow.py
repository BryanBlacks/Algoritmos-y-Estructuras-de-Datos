...
"border-color: rgb(0, 0, 0);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Interface/Images/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-color: rgb(0, 0, 0);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Interface/Images/121113.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
